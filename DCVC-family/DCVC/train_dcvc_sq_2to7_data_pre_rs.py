...
def main():
    ...
    parser.add_argument('--checkpoint_dir', type=str, default='results/checkpoints_data_rs', help='Directory to save checkpoints')
    parser.add_argument('--log_dir', type=str, default='results/logs_data_rs', help='Directory to save logs')
