...
def main():
    ...
    parser.add_argument('--vimeo_dir', type=str, default='/scratch/gautschi/zhan5096/dataset/Vimeo90k/vimeo_septuplet/sequences', 
                        help='Path to Vimeo-90k dataset')
    parser.add_argument('--save_dir', type=str, default='/scratch/gautschi/zhan5096/dataset/Vimeo90k/vimeo_septuplet/reference_sequences', 
...
if __name__ == '__main__':
    main()
    # python preprocessing.py --septuplet_list /scratch/gautschi/zhan5096/dataset/Vimeo90k/vimeo_septuplet/sep_trainlist.txt --i_frame_model_path /home/zhan5096/project/OpenDCVC/DCVC-family/DCVC/checkpoints/cheng2020-anchor-3-e49be189.pth.tar --quality_index 0
    # python preprocessing.py --septuplet_list /scratch/gautschi/zhan5096/dataset/Vimeo90k/vimeo_septuplet/sep_trainlist.txt --i_frame_model_path /home/zhan5096/project/OpenDCVC/DCVC-family/DCVC/checkpoints/cheng2020-anchor-4-98b0b468.pth.tar --quality_index 1 --cuda_device 1
    # python preprocessing.py --septuplet_list /scratch/gautschi/zhan5096/dataset/Vimeo90k/vimeo_septuplet/sep_trainlist.txt --i_frame_model_path /home/zhan5096/project/OpenDCVC/DCVC-family/DCVC/checkpoints/cheng2020-anchor-5-23852949.pth.tar --quality_index 2 
    # python preprocessing.py --septuplet_list /scratch/gautschi/zhan5096/dataset/Vimeo90k/vimeo_septuplet/sep_trainlist.txt --i_frame_model_path /home/zhan5096/project/OpenDCVC/DCVC-family/DCVC/checkpoints/cheng2020-anchor-6-4c052b1a.pth.tar --quality_index 3 --cuda_device 1